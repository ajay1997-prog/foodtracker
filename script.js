...
// State
let foodData = JSON.parse(localStorage.getItem('foodTrackerData')) || {};
...
function saveData(meal, key, value) {
    ...
    if (!foodData[currentDate][meal]) {
        foodData[currentDate][meal] = {};
    }

    foodData[currentDate][meal][key] = value;
    localStorage.setItem('foodTrackerData', JSON.stringify(foodData));
}
